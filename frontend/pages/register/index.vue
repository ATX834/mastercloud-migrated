<template>
  <div class="flex justify-center items-center min-h-[calc(100vh-5rem)]">
    ...
    <div v-if="error" class="bg-red-900 border border-red-700 text-red-100 px-4 py-3 rounded relative mb-4"
      ...
      <span class="block sm:inline">Une erreur est survenue lors de l'inscription</span>
    </div>
    >
    ...
    <form @submit.prevent="handleRegister" class="space-y-5">
      ...
      <div>
        <label for="confirmPassword" class="block text-sm font-semibold text-gray-300 mb-2">Confirmer le mot de
          passe</label>
      ...
      <div class="flex items-center pt-1">
        <input id="acceptTerms" type="checkbox" v-model="acceptTerms"
          class="rounded border-gray-600 text-blue-500 focus:ring-blue-500 focus:ring-offset-gray-900" required>
        <label for="acceptTerms" class="ml-2 text-sm text-gray-300">
          J'accepte les <a href="#" class="font-medium text-blue-400 hover:text-blue-300 transition-colors">conditions
            d&#39;utilisation</a>
        </label>
      </div>
